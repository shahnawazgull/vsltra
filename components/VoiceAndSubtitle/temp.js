...
export default function SubtitleEditor({
    ...
    const handleFontUpload = (fontUrl, fontName) => {
    ...
    return (
        <div className="">
            ...
            <div className="flex items-center justify-center mb-4">
                ...
                <h2 className="text-[18px] font-semibold text-center">Subtitle Design</h2>
            </div>
            ...
            <div className="mt-4">
                <InputFile
                    ...
                    required
                    onChange={handleFontUpload} // Handling font upload
                    className="custom-input"
                    labelStyle="text-[18px] font-semibold text-[#000000] mb-2" // Styling for label
                />

                <div className="grid grid-cols-2 gap-6 w-full mt-4">
                    <Button onClick={() => setFontSize((prev) => prev + 2)} className="py-2 px-[19px]">
                        Increase Font
                    </Button>
                    <Button onClick={() => setFontSize((prev) => prev - 2)} className="py-2 px-[19px]">
                        Decrease Font
